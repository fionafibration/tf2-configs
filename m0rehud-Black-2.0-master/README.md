...
**1)** Extract/Unzip the hud and copy the m0rehud Black 2.0 folder
...
The original rgb code for the damage numbers is: hud_combattext_red 102; hud_combattext_green 255; hud_combattext_blue 0
