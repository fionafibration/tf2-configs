Scheme
{
	...
	Colors
	{
		...
		"G_Highlight"			"255 0 225 255" // Highlight color
		...
		"G_LightGrey"			"0 0 0 255" // Metal color in build/destroy menu
		"G_HealthBarBg"			"0 0 0 220" // Target health bg
		"G_CurrencyBad"			"255 60 60 255" // Red currency in MvM
		"G_TransparentMenuBG"	"162 255 0 199" // Transparent menu color
		"G_PanelBg"				"212 0 192 199" // Panel color
		"G_OpaquePanelBg"		"212 0 192 255" // Opaque Panel color
		"G_Warning"				"0 0 0 255" // Warning color
		"G_HealthValue"			"0 0 0 255" // Health value color
		"G_Overheal"			"179 153 0 255" // Overhealed health value color
		"G_LowHealthValue"		"0 0 0 255" // Low health value color
		"G_AmmoClipValue"		"149 0 0 255" // Ammo in clip value color
		"G_AmmoReserveValue"	"27 0 249 255" // Ammo in reserve value color
		"G_LowAmmo"				"0 0 0 255" // Low ammo color
		"G_MetalValue"			"0 0 0 255" // Metal color
		"G_MetalIcon"			"194 0 0 255" // Metal icon color
		"G_HeadsValue"			"0 0 0 255" // Heads value color
		"G_HeadsLabel"			"48 97 0 255" // Heads value icon color
		"G_KillstreakValue"		"0 0 0 255" // Killstreak value color
		"G_KillstreakIcon"		"126 14 196 255" // Killstreak icon color
		"G_StickyColor"					"0 0 0 255" // Stickybomb color
		"G_StickyIconColor"				"172 0 0 255" // Stickybomb icon color
		"G_CustomTargetID" 				"183 170 0 255" // Custom target id bg color
		"G_TargetHealthValue" 			"0 0 0 255" // Target ID health value color
		"G_TargetHealthValueShadow" 	"0 0 0 219" // Target ID health value shadow color
		"G_Killfeed_Base"			"157 255 162 255" // Killfeed Base color
		"G_Killfeed_Local"			"0 251 49 240" // Killfeed Local color
		"G_CenteredMetalBg"			"60 60 60 255" // Centered metal background color
		"G_CenteredUberchargeBg"	 "232 251 0 255" // Centered ubercharge meter background color
		...
		"G_Footer"					"0 255 171 255" // Menu footer color
		"G_DimmFooter"				"28 23 19 200" // Dimm Menu footer color
		"G_FooterText"				"0 255 4 255" // Footer text color
		"G_DimmFooterText"			"0 255 4 120" // Dimm Footer text color
		"G_OuterBorder"				"255 255 255 255" // Outer border color
		"G_InnerBorder"				"30 162 199 255" // Inner border color
		"G_KillfeedBlue"			"255 161 244 255" // Killfeed blue text
		"G_KillfeedRed"				"161 255 205 255" // Killfeed red text
		"G_KillfeedIcon"			"255 255 255 255" // Killfeed icon color
		"G_CustomHealthValue"		"120 120 120 255"
		"G_MainMenuOverlay"			"238 27 27 255" // Main Menu overlay color
		"G_MainMenuButton"			"214 255 179 255" // Main Menu button color
		"G_MainMenuButtonHover"		"255 151 19 255" // Main Menu hovered button color
		"G_MainMenuButtonFg"		"255 255 255 255" // Main Menu button text color
		"G_MainMenuButtonHoverFg"	"255 0 236 255" // Main Menu hovered button text color
		"G_MainMenuShader" 			"171 190 0 255" // Main Menu shader color
		"G_BackpackItemBg"			"255 255 255 255" // Backpack item bg color
		"G_LoadoutItemBg"			"255 255 255 255" // Loadout item bg color
		"G_MenuBg"					"240 163 255 255" // Menu bg color
		"G_MenuText"				"240 0 255 255" // Menu text color
		"G_InputText"				"255 0 0 240" // Input text color
		"G_DimmInputText"			"255 0 0 100" // Dimm Input text color
		"G_DimmMenuText"			"240 0 255 120" // Dimm Menu text color
		"G_ItemDescriptionPanelBg"	"0 255 146 255" // Item description panel bg
		"G_ButtonBg"				"255 4 4 255" // Button bg color
		"G_ButtonText"				"214 206 200 255" // Button text color
		"G_ButtonHoverBg"			"95 189 21 255" // Button hover bg color
		"G_ButtonHoverText"			"255 255 255 255" // Button hover text color
		"G_ButtonSelectedBg"		"255 243 0 255" // Button selected bg color
		...
		"G_ItemMeterBg"				"0 255 255 255" // Item meter bg
		"G_ItemMeterBorder"			"255 0 243 255" // Item meter border color
		"G_MenuShader"				"6 0 255 232" // Menu shader color
		"G_ItemEffectMeterLineColor"	"120 120 120 130"
		"G_MvmLobbyPanelBg"			"40 40 40 255"
		"G_MvmLobbyPanelText"		"220 220 220 255"
		
		// Crosshairs
		"G_Crosshair1Color"		"0 5 6 255" // Crosshair1 color
		"G_Crosshair2Color"		"29 255 2 255" // Crosshair2 color
		"G_Crosshair3Color"		"0 0 0 255" // Crosshair3 color
		...
		"TFOrange"			"255 0 225 255" // Highlight color
		...
		"QualityColorrarity1"					"255 0 0 255" // IQC Genuine
		"QualityColorrarity2"					"141 131 75 255"
		"QualityColorrarity3"					"204 204 250 255"
		"QualityColorrarity4"					"134 80 172 255" // IQC Unusual
		"QualityColorVintage"					"255 0 0 255" // IQC Vintage
		"QualityColorUnique"					"255 0 0 255" // IQC Unique
		"QualityColorCommunity"					"95 255 0 255" // IQC Community
		"QualityColorDeveloper"					"255 0 180 255" // IQC Valve
		"QualityColorSelfMade"					"95 255 0 255" // IQC Community
		"QualityColorCustomized"				"71 98 145 255"
		"QualityColorStrange"					"255 0 0 255" // IQC Strange
		"QualityColorCompleted"					"134 80 172 255"
		"QualityColorHaunted"					"255 0 0 255" // IQC Haunted
		"QualityColorCollectors"				"255 7 7 255" // IQC Collectors
		"QualityColorPaintkitWeapon"			"250 250 250 255" // IQC PaintkitWeapon
		
		"DimmQualityColorNormal"				"255 0 0 100" // Dimm IQC Normal
		"DimmQualityColorrarity1"				"255 0 0 100" // Dimm IQC Genuine
		...
		"DimmQualityColorVintage"				"255 0 0 100" // Dimm IQC Vintage
		"DimmQualityColorUnique"				"255 0 0 100" // Dimm IQC Unique
		"DimmQualityColorCommunity"				"95 255 0 100" // Dimm IQC Community
		"DimmQualityColorDeveloper"				"255 0 180 100" // Dimm IQC Valve
		"DimmQualityColorSelfMade"				"95 255 0 100" // Dimm IQC Community
		"DimmQualityColorCustomized"			"71 98 145 100"
		"DimmQualityColorStrange"				"255 0 0 100" // Dimm IQC Strange
		"DimmQualityColorCompleted"				"134 80 172 100"
		"DimmQualityColorHaunted"				"255 0 0 100" // Dimm IQC Haunted
		"DimmQualityColorCollectors"			"255 7 7 100" // Dimm IQC Collectors
	...
	BaseSettings
	{
		...
		Slider.NobColor				"255 0 225 255" // Highlight color
		Slider.TextColor			"240 0 255 255" // Menu text color
		Slider.TrackColor			"240 0 255 255" // Menu text color
		Slider.DisabledTextColor1	"240 0 255 120" // Dimm Menu text color
		Slider.DisabledTextColor2	"240 0 255 120" // Dimm Menu text color
