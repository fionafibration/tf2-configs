Scheme
{
	...
	Fonts
	{
		...
		"G_FontHuge"
		{
			"1"
			{
				"name"			"Toe the Line Regular" [$WINDOWS] // Primary font
				"name"			"Toe the Line Regular" [!$WINDOWS] // Primary font
		...
		"G_FontHuge_2"
		{
			"1"
			{
				"name"			"Toe the Line Regular" [$WINDOWS] // Secondary font
		...
		"G_FontHealth"
		{
			"1"
			{
				"name"			"Toe the Line Regular" [$WINDOWS] // Health Font | Primary font
				"name"			"Toe the Line Regular" [!$WINDOWS] // Health Font | Primary font
		...
		"G_FontAmmo"
		{
			"1"
			{
				"name"			"Toe the Line Regular" [$WINDOWS] // Ammo Font | Primary font
				"name"			"Toe the Line Regular" [!$WINDOWS] // Ammo Font | Primary font
		...
		"G_FontDamage"
		{
			"1"
			{
				"name"			"Toe the Line Regular" [$WINDOWS] // Damage font | Primary font
				"name"			"Toe the Line Regular" [!$WINDOWS] // Damage font | Primary font
				"tall"			"20" // Damage size
				"weight"		"0"
				"additive"		"0"
		...
		"G_FontCritDamage"
		{
			"1"
			{
				"name"			"Toe the Line Regular" [$WINDOWS] // Crit damage font | Primary font
				"name"			"Toe the Line Regular" [!$WINDOWS] // Crit damage font | Primary font
		...
		"G_FontTargetIDHealth"
		{
			"1"
			{
				"name"			"Toe the Line Regular" [$WINDOWS] // Target ID health font | Primary font
				"name"			"Toe the Line Regular" [!$WINDOWS] // Target ID health font | Primary font
		...
		"CloseCaption_Normal"
		{
			"1"
			{
				"name"		"Toe the Line Regular" [$WINDOWS] // Closed captions font | Secondary font
	...
	CustomFontFiles
	{
		...
		"9" "resource/fonts/ToonHUD Toe the Line Regular.ttf"
		...
		"19" "resource/fonts/Toe the Line Regular.ttf"
	}
}
